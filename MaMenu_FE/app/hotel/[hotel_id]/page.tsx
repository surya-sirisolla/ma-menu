...
export default function HotelDashboard() {
  ...
  const stats: Stat[] = [
    { label: 'Total Tables',    value: activeTables.length,   icon: Grid3x3,         color: 'brand',   href: `/hotel/${hotel_id}/tables` },
    { label: 'Occupied Now',    value: occupiedTables.length, icon: Users,            color: 'amber',   href: `/hotel/${hotel_id}/tables` },
    { label: 'Menu Items',      value: availableItems.length, icon: UtensilsCrossed,  color: 'violet',  href: `/hotel/${hotel_id}/menu` },
    { label: 'Categories',      value: catCount,              icon: Tag,              color: 'emerald', href: `/hotel/${hotel_id}/categories` },
  ]
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="card">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href={`/hotel/${hotel_id}/tables`} className="text-xs text-brand-600 hover:underline">View all</Link>
          </div>
          {loading ? (
            <div className="space-y-2">
              {[...Array(4)].map((_, i) => (
        ...
        <div className="card">
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href={`/hotel/${hotel_id}/menu`} className="text-xs text-brand-600 hover:underline">View all</Link>
          </div>
          {loading ? (
            <div className="space-y-2">
              {[...Array(4)].map((_, i) => (
